...
model.summary()
optimizer = tf.keras.optimizers.RMSprop(0.001)  #设置学习率
train_db = tf.data.Dataset.from_tensor_slices((normed_train_data.values, train_labels.values))  #打乱顺序
